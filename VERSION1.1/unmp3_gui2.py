...
class EncodeTab(tk.Frame):
    ...
    def _run(self):
        ...
        def worker():
            try:
                # ▼▼▼ ONE-LINE FIX: Switch CWD to the input file's drive/directory ▼▼▼
                os.chdir(Path(wav).parent)
...
class TestTab(tk.Frame):
    ...
    def _run(self):
        ...
        def worker():
            try:
                # ▼▼▼ ONE-LINE FIX: Switch CWD to the output directory ▼▼▼
                os.chdir(out)
