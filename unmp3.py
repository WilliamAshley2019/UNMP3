...
class UnMP3Codec:
    ...
    def encode(self, wav_path, mp3_path, unmp3_path):
    ...
    def decode(self, mp3_path, unmp3_path, output_wav_path):
...
def main():
    ...
    if args.command == 'test':
        ...
        codec = UnMP3Codec()
        codec.decode(args.input1, args.input2, args.output)
